...
public class PaginationElementTagProcessor extends AbstractElementTagProcessor {
	...
	private static final String ATTR_NAME_PREFIX = "pagination";
	private static final int PRECEDENCIA = 1000;

	public PaginationElementTagProcessor(final String dialectPrefix) {
		super(TemplateMode.HTML, dialectPrefix, ATTR_NAME_PREFIX, true, null, false, PRECEDENCIA);
	}
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
		...
		IAttribute page = tag.getAttribute("pagination");
