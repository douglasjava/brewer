...
public class VendasController {
	...
	public ModelAndView alterarQuantidadeItem(@PathVariable("codigoCerveja") Cerveja cerveja, @Valid @RequestBody AlteraQuantidade alteraQuantidade) {
		tabelaItens.alterarQuantidadeItens(alteraQuantidade.getUuid(), cerveja, alteraQuantidade.getQuantidade());
		return mvTabelaItensVenda(alteraQuantidade.getUuid());
	}
